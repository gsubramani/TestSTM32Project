...
void pwm_gen()
{
	...
	GPIO_InitTypeDef GPIO_D;	// SEE 19.2.2 of HAL driver manual
	  ...
	  HAL_GPIO_Init(GPIOD,&GPIO_D);
	  TIM_HandleTypeDef TIM_handle;
	  //HAL_TIM_PWM_MspInit(&TIM_handle); - > Does nothing :/
	  ...
	  TIM_OC_type_def.OCFastMode = TIM_OCMODE_TOGGLE;
	  ...
	  TIM_OC_type_def.OCIdleState = TIM_OCIDLESTATE_SET;
	  TIM_OC_type_def.OCNIdleState = TIM_OCNIDLESTATE_SET;
